...
| `ctx.runtimeBroker` | `core` | [`runtime-broker`](../packages/runtime/broker) | - | [`fs-broker`](../packages/runtime/fs-broker), [`subprocess-broker`](../packages/runtime/subprocess-broker) | - | Owns shared transport, mutation generations, and terminal quota state for one Runtime lease; native tools use the same owner. |
